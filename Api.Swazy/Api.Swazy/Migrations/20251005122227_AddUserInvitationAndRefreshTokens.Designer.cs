...
namespace Api.Swazy.Migrations
{
    ...
    [Migration("20251005122227_AddUserInvitationAndRefreshTokens")]
    partial class AddUserInvitationAndRefreshTokens
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Swazy.Models.Entities.EmployeeDaySchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("EmployeeWeeklyScheduleId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EmployeeWeeklyScheduleId", "DayOfWeek")
                        .IsUnique();

                    b.ToTable("EmployeeDaySchedules");
                });

            modelBuilder.Entity("Api.Swazy.Models.Entities.EmployeeWeeklySchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("VacationFrom")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("VacationTo")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("EmployeeWeeklySchedules");
                });
            ...
            modelBuilder.Entity("Api.Swazy.Models.Entities.EmployeeDaySchedule", b =>
                {
                    b.HasOne("Api.Swazy.Models.Entities.EmployeeWeeklySchedule", "EmployeeWeeklySchedule")
                        .WithMany("DaySchedules")
                        .HasForeignKey("EmployeeWeeklyScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EmployeeWeeklySchedule");
                });
